...
<table width="80%" border="0" align="center">
  ...
  <tr>
    <td><img src="<?php echo $banner;?>" width="100%"></td>
  </tr>
</table>
...
<a href="statement_print.php?id=<?php echo $stand;?>" target="_blank" class='btn btn-success'>&nbsp;<i class='icon-file-alt icon-large'></i>&nbsp; <strong>CLICK TO PRINT</a></strong>
</td>
  </tr>
</table>
