...
$sms3 = mysql_query("SELECT * FROM `clients` GROUP BY stand_id")or die(mysql_query());
...
<password>tS8ff1Cg11</password>
</authentification>
";
while($rowsms = mysql_fetch_array($sms3))
{
$msgsms="Hello $rowsms[name] $rowsms[surname],we would like to notify you that we will be moving to 1st Floor ,Office PD30, CAIPF buildning with effect from 1 July 2015";
