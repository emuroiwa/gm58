...
error_reporting(0);
	 include 'opendb.php';
		...
		$item=$_POST['user'];
		$result = mysql_query("select * from users where username = '$item' and suspend = '1' and username !='admin'");
...
<div class="col-2">
				<div class="indent">
					<h1 align="center">Suspend Users Module</h1>
					<p align="center"><em>Enter username of the employee you want to suspend and then confirm with the details below.</em></p>
				  <div id="text">
		  ...
		  <tr><?php //echo $_SESSION['d'] ;?>
            ...
            <td width="224">
              ...
              <input type="submit" name="Search" value="Find" /></td>
                    ...
                    <div align="center" class="style1">Suspension Confirmation Details                                        </div>
