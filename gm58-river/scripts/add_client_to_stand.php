...
-->    <th width="181"><span class="style2">ADD CLIENTS</span></th>
    ...
    <td bgcolor="#FFFFFF"><span class="style2"><?php   echo "<a href='index.php?page=reg1.php&id=$row[id_stand]' class='btn btn-success'><i class='icon-file-alt icon-large'></i>&nbsp; <strong>Add Client</a>";
 ?></span></td>
