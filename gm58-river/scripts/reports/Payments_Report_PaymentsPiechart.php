...
$Chart->ID = "Payments_Report_PaymentsPie"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Payments_Report_PaymentsPie", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Payments_Report_PaymentsPie_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
