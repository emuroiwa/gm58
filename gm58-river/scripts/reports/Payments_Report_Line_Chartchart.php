...
$Chart->ID = "Payments_Report_Line_Chart"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Payments_Report_Line_Chart", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Payments_Report_Line_Chart_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
