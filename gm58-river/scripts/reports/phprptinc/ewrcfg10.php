...
define("EWR_PROJECT_ID", "{3080AF49-5443-4264-8421-3510B6183D7C}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "GM58", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "choicesroot", "pass" => "password1*", "db" => "gm58", "qs" => "`", "qe" => "`");
...
define("EWR_CODEPAGE", 28596, TRUE); // Code page
define("EWR_CHARSET", "iso-8859-6", TRUE); // Project charset
...
define("EWR_RANDOM_KEY", 'aBMJPA6hF7XmZ2E5', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/GM58.css", TRUE); // Project stylesheet file name
 ...
 * details.
 */
define("EWR_ENCODING", "ISO-8859-6", TRUE); // Character encoding
...
define("EWR_SMTP_SERVER_USERNAME", "gm58system@gmail.com", TRUE); // SMTP server user name
define("EWR_SMTP_SERVER_PASSWORD", "password1*", TRUE); // SMTP server password
