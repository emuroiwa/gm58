...
$Chart->ID = "Payments_Report_PaymentsBar"; // Chart ID
$Chart->SetChartParms(array(array("type", "104", FALSE),
...
$Chart->Trends[] = array(0, 0, "9966FF", "", 1, "0", "1", 100, "", "0", "0", 0, 0, "");
$Chart->Trends[] = array(0, 0, "808080", "", 1, "0", "1", 100, "", "0", "0", 0, 0, "");
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Payments_Report_PaymentsBar", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Payments_Report_PaymentsBar_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
