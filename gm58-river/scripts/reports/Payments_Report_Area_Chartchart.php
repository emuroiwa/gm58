...
$Chart->ID = "Payments_Report_Area_Chart"; // Chart ID
$Chart->SetChartParms(array(array("type", "7", FALSE),
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Payments_Report_Area_Chart", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Payments_Report_Area_Chart_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
