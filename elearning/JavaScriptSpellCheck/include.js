...
if(livespell.insitu.hasChanged(id)){this.checkNow(id,providerId)}},updateProxy:function(id){var value=E$(id).value
...
n.ondrop=function(e){var newContent=e.dataTransfer.getData('Text')+'';if(newContent=='null'){return false;}
