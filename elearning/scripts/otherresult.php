...
$checkrw = mysql_num_rows($check);
 ...
 alert(" ..................MARK AND REMARKS ALREADY CAPTURED!!!!!!!!!!")
...
function MM_validateForm() { //v4.0
  ...
  <?php if ($_GET['name']=="Extra_Mural_Actvites"){ 
  ?>
   <style>
		.hide
		{
		...
		<form action="" method="post" onSubmit="MM_validateForm('remark','','R');return document.MM_returnValue"><!--A....80% and above<br>B....between 70% and 79%<br>C....between 50% and 69%<br>U....49% and below-->
...
VALUES
('$_REQUEST[reg]','$_POST[remark]','$_SESSION[year]','$_SESSION[term]','$date','$_REQUEST[name]')") or die (mysql_error());
?>
...
<script language="javascript">
 alert("Remarks updated");
  ...
  <?php
  header("location: index.php?page=tab.php&reg=$_GET[reg]&name=$_GET[zita]&surname=$_GET[surname]&level=$_GET[level]#other"); 
   }
		?>