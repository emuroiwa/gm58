...
<br />
  ...
  <tr>
    ...
    <td width="190">Number of characters required 
        <label id="lblcount8" style="background-color:#E2EEF1;color:Red;font-weight:bold;">800</label><br/>
       <textarea name="remark" id="remark" rows="10" cols="85" onkeyup="LimtCharacters8(this,800,'lblcount8');" maxlength="175"><?php echo $_REQUEST['remark']; ?></textarea>
