...
section { padding:0 !important; margin:0 !important; height:24.2cm !important; width:27.5cm; overflow:hidden !important; }
</style>
</head>
...
<table width="100%" border="0" align="center" style="border-image-slice:fill">
      <tr>
        ...
        <td width="20%" ><strong>PUPIL'S</strong></td>        
...
<p align="left">Symbols:  A=Excellent  B=Good  C=Satisfactory  D=Poor  E=Weak/Unsatisfactory<br>Note:-Attainment is an assessment of child's attainment in relation to the whole class: Effort is an assessment as an individual.</p><hr>
...
<table width="377" border="1">
 <tr>
    ...
    <td width="77%"><table width="100%"  border="1" bgcolor="#FFFFFF">
      <tr>
        <td width="504" height="93"><?php echo $maths_remarks; ?></td>
      </tr>
    </table> </td>
  </tr>
  <tr>
    ...
    <td><table width="100%" border="1" bgcolor="#FFFFFF">
      <tr>
        <td width="328" height="190" ><?php echo $english_remarks; ?></td>
      </tr>
    </table><tr>
    <td><table width="377" border="1">
      <tr height="40">
  ...
  <tr>
    <td><table width="377" border="1"  height="100">
      ...
      <tr>
        ...
        <td width="53" ><?php echo $ss_mark; ?></td>
         <td width="50" ><?php echo $ss_mark; ?></td>
           </tr>
    </table></td>
    <td><table width="100%"  border="1" bgcolor="#FFFFFF">
      <tr>
        <td width="304" height="91.25" ><?php echo $content_remarks; ?>
       </td>
      </tr>
    </table></td>
  </tr>
...
<td width="3%"><strong>V.Good</strong></td> 
      ...
      <tr>
        ...
        <td ><strong>GENERAL REMARKS: </strong><?php echo remarks('overall',$_SESSION['year'],$_SESSION['term']);	  ; ?></td> 
...
<?php $gethead = mysql_query("SELECT * FROM remarks , users WHERE remarks.teacher = users.username and remarks.student='$_GET[reg]'")or die(mysql_query()); 
	while($rowhead = mysql_fetch_array($gethead, MYSQL_ASSOC)){
		$teacher=$rowhead['surname']." ".$rowhead['namee'];}
		$gethead1 = mysql_query("SELECT * FROM users WHERE access = '2' ")or die(mysql_query()); 
	while($rowhead1 = mysql_fetch_array($gethead1, MYSQL_ASSOC)){
		$teacher1=$rowhead1['surname']." ".$rowhead1['namee'];
		}?>
    Class teacher:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "<strong>$teacher</strong>"; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Head:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "<strong>$teacher1</strong>"; ?> 
</body>
</html>