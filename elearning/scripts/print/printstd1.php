...
<img src="../../student/images/object750153973.png" height="120"><hr>
...
<table width="377" border="1">
 <tr>
    ...
    <td width="77%"><table width="100%"  border="1" bgcolor="#FFFFFF">
      <tr>
        <td width="504" height="75"><?php echo $maths_remarks; ?></td>
      </tr>
    </table> </td>
  </tr>
  <tr>
    ...
    <td><table width="100%" border="1" bgcolor="#FFFFFF">
      <tr>
        <td width="328" height="176" ><?php echo $english_remarks; ?></td>
      </tr>
    </table><tr>
    <td><table width="377" border="1">
      <tr height="40">
  ...
  <tr>
    ...
    <td><table width="100%"  border="1" bgcolor="#FFFFFF">
      <tr>
        <td width="304" height="56.25" ><?php echo $content_remarks; ?>
       </td>
      </tr>
    </table></td>
  </tr>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="71%"><table width="100%" border="1">
      <tr>
        <td width="202" height="37.5" ><?php echo $comp_remarks; ?></td>
      </tr>
    </table><table width="100%" border="1">
      <tr>
        <td width="202"  height="37.5"  ><?php echo $art_remarks; ?></td>
      </tr>
    </table><table width="100%" border="1">
      <tr>
        <td width="202"  height="37.5" ><?php echo $extra_remarks; ?></td>
      </tr>
    </table></td>
  </tr>
</table><table width="100%" border="1">
...
<?php $gethead = mysql_query("SELECT * FROM remarks , users WHERE remarks.teacher = users.username and remarks.student='$_GET[reg]'")or die(mysql_query()); 
    ...
    Class teacher:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "<strong>$teacher</strong>"; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Head:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "<strong>$teacher1</strong>"; ?> </section>
</body>
</html>