...
<script type="text/javascript" src="jquery-ui-1.7.custom.min.js"></script><?php 
  ...
  $result111 = mysql_query("SELECT * FROM marksbook ,student ,student_class WHERE marksbook.reg = student.reg AND term ='$_SESSION[term]' AND marksbook.session ='$_SESSION[year]' AND  marksbook.reg = '$_SESSION[reg]'   AND student.reg = student_class.student and subject_id='maths' and marksbook.date='$_GET[date]' and marksbook.status='0' ")or die(mysql_query());
