...
<br>
<br>
<center><h4>Please enter you student number and email to recover your password</h4><br />
<form action="" method="post"   >
        
          <table width="50%" border="0" align="center">
  <tr>
    <td width="27%">Student Number</td>
...
$sql="SELECT * FROM student WHERE reg='$username' AND email='$email' and status='ENROLLED'"; 
