...
$username = clean(qoutess($_POST["regnum"]));
$password = clean(qoutess($_POST["password"]));
  ...
  if($username == '' OR $password == ''){
		  ...
		  javascript:history.go(-1)
		   ...
		   $resul = mysql_query("SELECT * from student where reg='$username' AND password = '$password' and suspend='0'");
...
$query = "SELECT * from student where reg='$username' AND password = '$password' and suspend='1'";
